...
const iconosDisponibles = [
    ...
    { icon: 'fa-solid fa-pump-soap', label: 'pump-soap - Jabón' },
    { icon: 'fa-solid fa-hand-sparkles', label: 'hand-sparkles - Desinfección' },
    { icon: 'fa-solid fa-wind', label: 'wind - Ventilación' },
    ...
    { icon: 'fa-solid fa-person-digging', label: 'person-digging - Excavación' },
    { icon: 'fa-solid fa-trowel-bricks', label: 'trowel-bricks - Mampostería' },
    ...
    { icon: 'fa-solid fa-battery-full', label: 'battery-full - Batería' },
    { icon: 'fa-solid fa-plug-circle-bolt', label: 'plug-circle-bolt - Instalación' },
    { icon: 'fa-solid fa-solar-panel', label: 'solar-panel - Panel Solar' },
    { icon: 'fa-solid fa-bolt-lightning', label: 'bolt-lightning - Alta Tensión' },
    ...
    // MUEBLES Y HOGAR
    { icon: 'fa-solid fa-couch', label: 'couch - Sofá' },
    ...
    { icon: 'fa-solid fa-truck', label: 'truck - Camión' },
    ...
    { icon: 'fa-solid fa-truck-fast', label: 'truck-fast - Envío Rápido' },
    
    // JARDINERÍA Y PAISAJISMO
    { icon: 'fa-solid fa-tree', label: 'tree - Árbol' },
    ...
    { icon: 'fa-solid fa-mug-hot', label: 'mug-hot - Café' },
    ...
    { icon: 'fa-solid fa-headphones', label: 'headphones - Audífonos' },
    ...
    { icon: 'fa-solid fa-shield-dog', label: 'shield-dog - Protección' },
    
    // SALUD Y CUIDADO
    { icon: 'fa-solid fa-heart-pulse', label: 'heart-pulse - Pulso' },
    { icon: 'fa-solid fa-suitcase-medical', label: 'suitcase-medical - Médico' },
    ...
    // EDUCACIÓN
    { icon: 'fa-solid fa-graduation-cap', label: 'graduation-cap - Graduación' },
    ...
    { icon: 'fa-solid fa-shield-halved', label: 'shield-halved - Protección' },
    ...
    { icon: 'fa-solid fa-music', label: 'music - Música' },
    { icon: 'fa-solid fa-microphone', label: 'microphone - Micrófono' },
    ...
    { icon: 'fa-solid fa-drum', label: 'drum - Batería' },
    { icon: 'fa-solid fa-camera-retro', label: 'camera-retro - Fotografía' },
    
    // OFICINA Y NEGOCIOS
    { icon: 'fa-solid fa-briefcase', label: 'briefcase - Maletín' },
    { icon: 'fa-solid fa-calculator', label: 'calculator - Calculadora' },
    { icon: 'fa-solid fa-print', label: 'print - Impresora' },
    { icon: 'fa-solid fa-chart-line', label: 'chart-line - Gráfica' },
    ...
    { icon: 'fa-solid fa-phone', label: 'phone - Teléfono' },
...
function openIconPicker(categoriaId, currentIcon) {
    // LIMPIEZA Y ASEO
    { icon: 'fa-solid fa-broom', label: 'broom - Escoba Limpieza' },
    { icon: 'fa-solid fa-spray-can', label: 'spray-can - Spray Limpieza' },
    { icon: 'fa-solid fa-pump-soap', label: 'pump-soap - Jabón Limpieza' },
    { icon: 'fa-solid fa-hand-sparkles', label: 'hand-sparkles - Desinfección Higiene' },
    { icon: 'fa-solid fa-wind', label: 'wind - Ventilación Aire' },
    { icon: 'fa-solid fa-toilet', label: 'toilet - Sanitario Limpieza' },
    { icon: 'fa-solid fa-dumpster', label: 'dumpster - Contenedor Basuras' },
    { icon: 'fa-solid fa-sponge', label: 'sponge - Esponja Limpieza' },
