...
<div class="dashboard-header dashboard-section" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; background: linear-gradient(135deg, #66a3e0, #71afed); padding: 20px 0px 20px 0px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); margin-top: 0.75rem; margin-bottom: 1.5rem;">
